...
function calculateElectricityEmissions() {
    ...
    const electricityEmissionFactor = parseFloat(document.getElementById('electricityEmissionFactor').value) || 0;
...
function calculateGasEmissions() {
    ...
    const gasEmissionFactor = parseFloat(document.getElementById('gasEmissionFactor').value) || 0;
...
function calculateWasteEmissions() {
    ...
    const wasteEmissionFactor = parseFloat(document.getElementById('wasteEmissionFactor').value) || 0;
